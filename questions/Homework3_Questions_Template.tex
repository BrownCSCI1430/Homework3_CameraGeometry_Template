...
\begin{subquestion}[points=1]
What effect does changing the parameters have on the final coordinates? Compare the image coordinates you calculated in 2.1.1 and 2.1.2. \textbf{[2--3 sentences]}
\end{subquestion}
