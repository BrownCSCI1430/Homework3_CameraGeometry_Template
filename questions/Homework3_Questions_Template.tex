...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pagebreak
\paragraph{Q5:} \textbf{[4 points]} Given a stereo pair of cameras:
\begin{enumerate} [(a)]
\item \textbf{[2 points]} Briefly describe triangulation (using images might be helpful).

\begin{mdframed}
TODO: Your answer to (a) here.
\end{mdframed}

\item \textbf{[2 points]} Why is it not possible to find an absolute depth for each point when we don't have calibration information for our cameras?
\begin{mdframed}
TODO: Your answer to (b) here.
\end{mdframed}
...
\item State an advantage and disadvantage of using each setup for depth reconstruction
