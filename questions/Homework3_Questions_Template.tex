...
\begin{subquestion}[points=2]
Show how to eliminate the unknown scale $w_i$. Then, write the resulting equations that are \emph{linear} in the 12 $m_{ij}$ entries of $\mathbf{M}$, and form a constraint by equating them to zero.
\end{subquestion}
